...
describe Projects::DestroyService, services: true do
  ...
  shared_examples 'handles errors thrown during async destroy' do |error_message|
    ...
    it 'stores an error message in `projects.delete_error`' do
      ...
      expect(project.delete_error).to contain(error)
    end
  end
  ...
  context 'with async_execute' do
    ...
    context 'errors' do
      context 'when `remove_legacy_registry_tags` fails' do
        ...
        it_behaves_like 'handles errors thrown during async destroy', "foo"
      end
      ...
      context 'when `execute` raises any other error' do
        ...
        it_behaves_like 'handles errors thrown during async destroy', "bar"
      end
    end
  end
